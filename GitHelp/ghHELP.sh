...
if [ "$1" == "-x" ]; then
    ...
    printf "$HELP_MESSAGE    ghNMB     -  create New Misc Branch\n"
    printf "$HELP_MESSAGE    ghNMBFE   -  create New Misc Branch From Epic\n"
    printf "$HELP_MESSAGE    ghNMBFR   -  create New Misc Branch From Release\n"
    ...
    printf "$HELP_MESSAGE    ghNJB     -  create New JIRA Branch (from development)\n"
    printf "$HELP_MESSAGE    ghNJBFE   -  create New JIRA Branch From Epic\n"
    printf "$HELP_MESSAGE    ghNJBFR   -  create New JIRA Branch From Release\n"
    printf "$HELP_MESSAGE    ghNJBFSHA -  New JIRA Branch From SHA\n"
