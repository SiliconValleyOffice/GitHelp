...
if [ $# -eq 0 ]; then
    ...
    printf "    Usage: ghCONFIG  Git_Host_URL  GitHub_user  git_root  ticket_type ticket_prefix  DEVELOPMENT_BRANCH\n"
...
if [ $# -ne 5 ]; then
  ...
  printf "    ghCONFIG GitHub_user git_root ticket_type ticket_prefix\n"
...
NEW_PROFILE="$NEW_PROFILE \nexport TICKET_PREFIX=$5"
NEW_PROFILE="$NEW_PROFILE \nexport DEVELOPMENT_BRANCH=$6"
